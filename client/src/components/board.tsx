        ...
        <div className="relative flex flex-col items-center">
            ...
            <div className="absolute bottom-5 space-x-4 flex items-center justify-center bg-slate-100 py-2 px-4 rounded-2xl">
                ...
                <Tooltip title="Pen" placement="top">
                    <Button onClick={() => setIsErasing(false)} className={`ml-4 px-4 py-2 bg-gray-200 border border-gray-400 rounded ${!isErasing ? "bg-gray-800" : null}`} >
                        <Pen />
                    </Button>
                </Tooltip>
                ...
                <Tooltip title="Erase" placement="top">
                    <Button onClick={() => setIsErasing(true)} className={`ml-4 px-4 py-2 border border-gray-400 rounded ${isErasing ? "bg-gray-800" : null}`} >
                ...
                <Tooltip title="Reset" placement="top">
                    <Button onClick={reset} className="ml-4 px-4 py-2 bg-rose-600 text-white border border-gray-400 rounded" >
                        Reset
                    </Button>
                </Tooltip>
                <Select
